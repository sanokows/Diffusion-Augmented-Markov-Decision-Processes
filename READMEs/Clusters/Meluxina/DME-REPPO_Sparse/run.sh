...
# run your code
chmod +x ./READMEs/Sweeps/DMERL/vanilla/sparse/run_sweep_dmerl_sparse_aux_loss.sh
sh ./READMEs/Sweeps/DMERL/vanilla/sparse/run_sweep_dmerl_sparse_aux_loss.sh