...
# run your code
chmod +x ./READMEs/Sweeps/DMERL/vanilla/linear_schedule/run_sweep_dmerl_asp_aux_loss_mult.sh
bash ./READMEs/Sweeps/DMERL/vanilla/linear_schedule/run_sweep_dmerl_asp_aux_loss_mult.sh
