...
# run your code
chmod +x ./READMEs/Sweeps/DMERL/vanilla/linear_schedule/run_sweep_dmerl_low_dim.sh
bash ./READMEs/Sweeps/DMERL/vanilla/linear_schedule/run_sweep_dmerl_low_dim.sh
