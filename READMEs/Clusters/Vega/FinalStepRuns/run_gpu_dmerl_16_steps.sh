...
# run your code
chmod +x ./READMEs/Sweeps/DMERL/vanilla/more_steps/Final_Runs/run_sweep_16_steps_tests.sh
bash ./READMEs/Sweeps/DMERL/vanilla/more_steps/Final_Runs/run_sweep_16_steps_tests.sh