...
# run your code
chmod +x ./READMEs/Sweeps/DMERL/vanilla/more_steps/Final_Runs/run_sweep_4_steps_tests.sh
bash ./READMEs/Sweeps/DMERL/vanilla/more_steps/Final_Runs/run_sweep_4_steps_tests.sh