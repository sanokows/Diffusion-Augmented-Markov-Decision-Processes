...
# run your code
chmod +x ./READMEs/Sweeps/DMERL/vanilla/linear_schedule/run_sweep_dmerl_arcsparse.sh
sh ./READMEs/Sweeps/DMERL/vanilla/linear_schedule/run_sweep_dmerl_arcsparse.sh