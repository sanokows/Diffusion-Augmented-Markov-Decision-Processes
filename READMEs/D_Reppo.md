...
python -m src.jaxrl.reppo env.name=G1JoystickFlatTerrain env=mjx_humanoid experiment_overrides=mjx_humanoid_large_data hyperparameters.num_eval=50 hyperparameters.normalize_reward=true hyperparameters.vmin=-50 hyperparameters.vmax=50 hyperparameters.num_bins=171
