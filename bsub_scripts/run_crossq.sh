...
METHOD="CROSSQ"   # Previously undefined, this is now set.

ENV_LIST=(CheetahRun HopperHop)
SEEDS=(1000 1001 1002 1003 1004 1005 1006 1007 1008 1009)
CONFIGS=("crossq")                # Configuration files to use
...
python src/jaxrl/crossq.py -cn ${CONFIG} env.name=${ENV_NAME} seed=${USING_SEED} hyperparameters.batch_size=${BATCH_SIZE} wandb.entity=${ENTITY}
EOF"
            done
        done
    done
