...
METHOD="DIME"   # Previously undefined, this is now set.

ENV_LIST=(CheetahRun HopperHop)
SEEDS=(1000 1001 1002 1003 1004 1005 1006 1007 1008 1009)
CONFIGS=("dime")                # Configuration files to use
# BATCH_SIZE_LIST=(1024 8192 16384)
BATCH_SIZE_LIST=(1024 5120 10240)
...
python src/jaxrl/dime.py -cn ${CONFIG} env.name=${ENV_NAME} seed=${USING_SEED} hyperparameters.batch_size=${BATCH_SIZE} wandb.entity=${ENTITY}
EOF"
            done
        done
    done
